        ...
        <div className="min-h-screen bg-white font-sans selection:bg-ucf-gold selection:text-ucf-black overflow-x-hidden">
            ...
            <section className="relative bg-neutral-900 py-20 md:py-28 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="w-full h-full bg-[url('/rosen-hero-optimized.jpg')] bg-cover bg-center opacity-80 transition-all duration-[2s] transform scale-105 hover:scale-110"></div>
                </div>
